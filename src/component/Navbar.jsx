...
<div>
  ...
  <ul className="uu ">
    <Link to={"/home"}><li className="ll"><div href="#" className="aba ">Blogs</div></li></Link>
    <Link to={"/personality"}><li className="ll"><div href="#" className="aba bb">Personality Test</div></li></Link>
    <Link to={"/humour"}><li className="ll"><div href="#" className="aba">Humour</div></li></Link>
   <Link to={"/imagination"}> <li className="ll"><div href="#" className="aba">Imagination</div></li></Link>
    {/* <li className="ll"><div href="#" className="aba">Support</div></li> */}
  </ul>
    </section>
