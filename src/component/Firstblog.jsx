        ...
        <div className='max-w-[1240px] mx-auto'>
            ...
            md:gap-x-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss:pt-20 text-black'>
                ...
                <div className='col-span-2 '>
                    ...
                    <img  className="h-56 w-full object-cover" alt='firstblogImg' src={firstblog.attributes.firstblogImg.data.attributes.url}/>
                ...
                <div className='items-center w-full bg-white rounded-xl drop-shadow-md py-5 max-h-[250px]'>
                    <div>
                        <img className='p-2 w-32 h-32 rounded-full mx-auto object-cover' alt='authorImg' src={firstblog.attributes.authorImg.data.attributes.url} />
