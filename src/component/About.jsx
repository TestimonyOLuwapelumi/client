...
We want to have positive influence on our audience, unlock their creative minds and build a bigger creative industry.
        ...
        <Link to={"https://www.instagram.com/_thx411/"}>
            <div className="lg:w-full w-20 bg-blue-800 text-white font-semibold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center lg:px-2 lg:py-3 py-0 px-0 mt-0 lg:mt-6 lg:text-3xl text-0  hidden lg:block">
                @_thx411
            </div>
            </Link>
      ...
      <span className="spann leftt"></span>
        ...
        <Link to={"https://twitter.com/_thx411"}>
            <div className="lg:w-full w-20 bg-blue-800 text-white font-semibold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center lg:px-2 lg:py-3 py-0 px-0 mt-0 lg:mt-6 lg:text-3xl text-1xl  hidden lg:block">
            @_thx411
            </div>
            </Link>
            <span className="spann topp"></span>
