  ...
  return (
    ...
    <Link to={`/personality/${personality.id}`}>
			<div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline    cardd">
				<img role="presentation" className="object-cover w-full rounded h-96" alt='personal' src={personality.attributes.personalImg.data.attributes.url} />
    ...
    {humour.map((humour)=>
     <Link to={`/humour/${humour.id}`}>
			<div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline    cardd">
				<img role="presentation" alt='humour' className="object-cover w-full rounded h-96   " src={humour.attributes.humourImg.data.attributes.url} />
				<div className="p-6 space-y-2">
     ...
     <Link to={`/imagination/${imagination.id}`}>
			<div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline    cardd">
				<img role="presentation" alt='imagiantion' className="object-cover w-full rounded h-96   " src={imagination.attributes.imaginationImg.data.attributes.url} />
				<div className="p-6 space-y-2">
    ...
    <div className="lg:hidden border-b-2">
        ...
        backgroundPosition: "center",
			...
			<div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline     hidden lg:block cardd">
				<img role="presentation" alt='personal' className="object-cover w-full rounded h-72   " src={personality.attributes.personalImg.data.attributes.url} />
				<div className="p-6 space-y-2">
        <h6 className='text-blue-800'>#Personality Test</h6>
					<h3 className="text-2xl font-semibold   group-focus:underline">{personality.attributes.personalityTitle}</h3>
					<span className="text-xs ">{personality.attributes.personalityDesc}</span>
     ...
     <Link to={`/humour/${humour.id}`}>
      <div className="lg:hidden ">
        ...
        backgroundPosition: "center",
			...
			<div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline     hidden lg:block cardd">
				<img role="presentation" alt='humour' className="object-cover w-full rounded h-72   " src={humour.attributes.humourImg.data.attributes.url} />
				<div className="p-6 space-y-2">
        <h6 className='text-blue-800'>#Humour</h6>
					<h3 className="text-2xl font-semibold   group-focus:underline">{humour.attributes.humourTitle}</h3>
					<span className="text-xs ">{humour.attributes.humourDesc}</span>
     ...
     <Link to={`/imagination/${imagination.id}`}>
      <div className="lg:hidden border-b-2">
        ...
        backgroundPosition: "center",
			...
			<div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline     hidden lg:block cardd">
				<img role="presentation" alt='imagination' className="object-cover w-full rounded h-72   " src={imagination.attributes.imaginationImg.data.attributes.url} />
				<div className="p-6 space-y-2">
        <h6 className='text-blue-800'>#Imagination</h6>
					<h3 className="text-2xl font-semibold   group-focus:underline">{imagination.attributes.imaginationTitle}</h3>
					<span className="text-xs ">{imagination.attributes.imaginationDesc}</span>
...
<section className="   ">
    ...
    <div className="lg:hidden border-b-2">
        ...
        backgroundPosition: "center",
          ...
          <div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline     hidden lg:block cardd">
				<img role="presentation" alt='blogImg' className="object-cover w-full rounded h-64   " src={blog.attributes.blogImg.data.attributes.url} />
				<div className="p-6 space-y-2">
...
<section className="   ">
    ...
    {imagination4.map((imagination)=>
        <Link to={`/imagination/${imagination.id}`}>
          ...
          <div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline     hidden lg:block cardd">
            <img role="presentation" alt='imaginate' className="object-cover w-full rounded h-72   " src={imagination.attributes.imaginationImg.data.attributes.url} />
            <div className="p-6 space-y-2">
            <h6 className='text-blue-800'>#Imagination</h6>
              <h3 className="text-2xl font-semibold   group-focus:underline">{imagination.attributes.imaginationTitle}</h3>
              <span className="text-xs ">{imagination.attributes.imaginationDesc}</span>
    ...
    {blog1.map((blog)=>
     <Link to={`/blog/${blog.id}`}>
          ...
          <div rel="noopener noreferrer"   className="max-w-sm mx-auto group hover:no-underline focus:no-underline     hidden lg:block cardd">
            <img role="presentation" alt='blog' className="object-cover w-full rounded h-72   " src={blog.attributes.blogImg.data.attributes.url} />
            <div className="p-6 space-y-2">
            <h6 className='text-blue-800'>#Newupdate</h6>
              <h3 className="text-2xl font-semibold   group-focus:underline">{blog.attributes.blogTitle}</h3>
              <span className="text-xs ">{blog.attributes.blogDesc}</span>
