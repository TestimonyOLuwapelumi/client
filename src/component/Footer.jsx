...
<footer ariaLabel="Site Footer" className="bg-black">
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="flex justify-center text-teal-600 text-center mx-auto">
     
      <img src={logo} alt="logo"  className='w-20 h-20 text-center mx-auto'/>
    ...
    <p className="mx-auto mt-0 max-w-md text-center leading-relaxed text-gray-100 hidden  hidden lg:block lg:text-1xl text-xs">
      Thx411 is a Big Media brand.
    </p>
    <p className="mx-auto mt-0 max-w-md text-center leading-relaxed text-gray-100  hidden lg:block lg:text-1xl text-xs">
    Copyright © 2023. All rights reserved.
    </p>
    {/* <h1 className='mx-auto mt-6 max-w-md text-center text-2xl lg:text-3xl text-gray-100'>What is the 411?</h1> */}


    <hr className='  block lg:hidden h-1'/>

    <nav ariaLabel="Footer Nav" className="mt-5">
      <ul className="flex flex-wrap justify-center gap-1 md:gap-8 lg:gap-12">
        ...
        {/* <li>
          <div className="text-gray-100 transition hover:text-gray-700/75"  >
            Blog
          </div>
        </li> */}
      </ul>
    ...
    <ul className="mt-3 flex justify-center gap-2 md:gap-8">
      {/* <li>
        <div 
      ...
      <li>
        <div 
          rel="noreferrer"
          target="_blank"
          className="text-gray-100 transition hover:text-blue-800"
        >
    ...
    <Link to={"https://twitter.com/_thx411"}>
      ...
      <li>
        ...
        >
          ...
          <svg fill="#ffffff" width="512px" height="512px" className="w-6 h-6 text-gray-100" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
      ...
      <li>
        ...
        >
          <span className="sr-only">Youtube</span>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff" className="w-6 h-6 text-gray-100">
    ...
    <hr className=' block lg:hidden h-1'/>
    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-100  block lg:hidden ">
    Copyright © 2023. All rights reserved.
    </p>
  </div>
</footer>
